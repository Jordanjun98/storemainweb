...
var Cc=H(uc,"gapi",{});var I;I=H(uc,"___jsl",Bc());H(I,"I",0);H(I,"hel",10);function Dc(){var a=wc.href;if(I.dpo)var b=I.h;else{b=I.h;var c=RegExp("([#].*&|[#])jsh=([^&#]*)","g"),d=RegExp("([?#].*&|[?#])jsh=([^&#]*)","g");if(a=a&&(c.exec(a)||d.exec(a)))try{b=decodeURIComponent(a[2])}catch(e){}}return b}
function Ec(a){var b=H(I,"PQ",[]);I.PQ=[];var c=b.length;if(0===c)a();else for(var d=0,e=function(){++d===c&&a()},f=0;f<c;f++)b[f](e)}
function Fc(a){return H(H(I,"H",Bc()),a,Bc())}
...
var Hc=new Gc;Hc.f=3950;var Ic=H(I,"perf",Bc());H(Ic,"g",Bc());var Jc=H(Ic,"i",Bc());H(Ic,"r",[]);Bc();Bc();function Kc(a,b,c){b&&0<b.length&&(b=Lc(b),c&&0<c.length&&(b+="___"+Lc(c)),28<b.length&&(b=b.substr(0,28)+(b.length-28)),c=b,b=H(Jc,"_p",Bc()),H(b,c,Bc())[a]=(new Date).getTime(),b=Ic.r,"function"===typeof b?b(a,"_p",c):b.push([a,"_p",c]))}
function Lc(a){return a.join("__").replace(/\./g,"_").replace(/\-/g,"_").replace(/,/g,"_")}
;var Mc=Bc(),Nc=[];function Oc(a){throw Error("Bad hint"+(a?": "+a:""));}
Nc.push(["jsl",function(a){for(var b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var c=a[b];"object"==typeof c?I[b]=H(I,b,[]).concat(c):H(I,b,c)}if(b=a.u)a=H(I,"us",[]),a.push(b),(b=/^https:(.*)$/.exec(b))&&a.push("http:"+b[1])}]);
...
function fd(){var a=I.nonce;if(void 0!==a)return a&&a===String(a)&&a.match(dd)?a:I.nonce=null;var b=H(I,"us",[]);if(!b||!b.length)return I.nonce=null;for(var c=vc.getElementsByTagName(cd),d=0,e=c.length;d<e;++d){var f=c[d];if(f.src&&(a=String(f.nonce||f.getAttribute("nonce")||"")||null)){for(var g=0,h=b.length;g<h&&b[g]!==f.src;++g);if(g!==h&&a&&a===String(a)&&a.match(dd))return I.nonce=a}}return null}
...
function ld(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);id(a,c);var d=a?a.split(":"):[],e=c.h||bd(),f=H(I,"ah",Bc());if(f["::"]&&d.length){for(var g=[],h=null;h=d.shift();){var l=h.split(".");l=f[h]||f[l[1]&&"ns:"+l[0]||""]||e;var n=g.length&&g[g.length-1]||null,t=n;n&&n.hint==l||(t={hint:l,features:[]},g.push(t));t.features.push(h)}var z=g.length;if(1<z){var q=c.callback;q&&(c.callback=function(){0==--z&&q()})}for(;d=g.shift();)md(d.features,c,d.hint)}else md(d||[],c,e)}
function md(a,b,c){function d(a,b){if(z)return 0;uc.clearTimeout(t);q.push.apply(q,w);var d=((Cc||{}).config||{}).update;d?d(f):f&&H(I,"cu",[]).push(f);if(b){Kc("me0",a,J);try{jd(b,c,n)}finally{Kc("me1",a,J)}}return 1}
a=Ac(a)||[];var e=b.callback,f=b.config,g=b.timeout,h=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var t=null,z=!1;if(g&&!h||!g&&h)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";l=H(Fc(c),"r",[]).sort();var q=H(Fc(c),"L",[]).sort(),J=[].concat(l);0<g&&(t=uc.setTimeout(function(){z=!0;h()},g));
var w=ed(a,q);if(w.length){w=ed(a,l);var na=H(I,"CP",[]),T=na.length;na[T]=function(a){function b(){var a=na[T+1];a&&a()}
function c(b){na[T]=null;d(w,a)&&Ec(function(){e&&e();b()})}
if(!a)return 0;Kc("ml1",w,J);0<T&&na[T-1]?na[T]=function(){c(b)}:c(b)};
if(w.length){var zc="loaded_"+I.I++;Cc[zc]=function(a){na[T](a);Cc[zc]=null};
a=Uc(c,w,"gapi."+zc,l);l.push.apply(l,w);Kc("ml0",w,J);b.sync||uc.___gapisync?gd(a):hd(a)}else na[T](xc)}else d(w)&&e&&e()}
function kd(a,b){if(I.hee&&0<I.hel)try{return a()}catch(c){b&&b(c),I.hel--,ld("debug_error",function(){try{window.___jsl.hefn(c)}catch(d){throw c;}})}else try{return a()}catch(c){throw b&&b(c),c;
}}
...
Math.min(n.left+n.width,q.left+q.width);l<=t&&(z=Math.max(n.top,q.top),q=Math.min(n.top+n.height,q.top+q.height),z<=q&&(n.left=l,n.top=z,n.width=t-l,n.height=q-z))}l=Tb(a);z=Tb(c);if(l.b!=z.b){t=l.b.body;z=dc(z.b);q=new D(0,0);var J=(J=Vb(t))?dc(J):window;b:{try{jb(J.parent);var w=!0;break b}catch(zc){}w=!1}if(w){w=t;do{var na=J==z?te(w):ue(w);q.x+=na.x;q.y+=na.y}while(J&&J!=z&&J!=J.parent&&(w=J.frameElement)&&(J=J.parent))}w=Rb(q,te(t));!C||9<=Number(Fb)||ac(l.b)||(w=Rb(w,bc(l.b)));n.left+=w.x;n.top+=
...
function xh(a,b){b.Rb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=O("XSRF_FIELD_NAME",void 0),d=b.Ha;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=Cg(f[1]||"");for(var g in d)f[g]=d[g];a=Af(c,f)+e}return a}
function yh(a,b){var c=O("XSRF_FIELD_NAME",void 0),d=O("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.L,g=O("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.Qb||uf(a.match(tf)[3]||null)&&!b.withCredentials&&uf(a.match(tf)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.L&&b.L[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Cg(e),db(e,f),e=b.Ab&&"JSON"==b.Ab?JSON.stringify(e):yf(e));if(!(c=e)&&(c=f)){a:{for(var l in f){f=!1;break a}f=!0}c=!f}!uh&&
c&&"POST"!=b.method&&(uh=!0,Ef(Error("AJAX request with postData should use POST")));return e}
function Ah(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Bh(b):null)d={},A(b.getElementsByTagName("*"),function(a){d[a.tagName]=Ch(a)})}c&&Dh(d);
return d}
function Dh(a){if(ta(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Qb(a[b]);a[c]=d}else Dh(a[b])}}
function Bh(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Ch(a){var b="";A(a.childNodes,function(a){b+=a.nodeValue});
return b}
function zh(a,b,c,d,e,f,g){function h(){4==(l&&"readyState"in l?l.readyState:0)&&b&&Df(b)(l)}
...
;function Eh(){var a=new mf;(a=a.isAvailable()?new sf(a,"yt.innertube"):null)||(a=new nf("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new hf(a):null;this.f=document.domain||window.location.hostname}
Eh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,Aa()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(de(b))}catch(f){return}else e=escape(b);b=this.f;Hc.set(""+a,e,c,"/",void 0===b?"youtube.com":b,!1)};
Eh.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=Hc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Eh.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;Hc.remove(""+a,"/",void 0===b?"youtube.com":b)};new Eh;var Fh=Aa().toString();var Gh;a:{if(window.crypto&&window.crypto.getRandomValues)try{var Hh=Array(16),Ih=new Uint8Array(16);window.crypto.getRandomValues(Ih);for(var Jh=0;Jh<Hh.length;Jh++)Hh[Jh]=Ih[Jh];Gh=Hh;break a}catch(a){}for(var Kh=Array(16),Lh=0;16>Lh;Lh++){for(var Mh=Aa(),Nh=0;Nh<Mh%23;Nh++)Kh[Lh]=Math.random();Kh[Lh]=Math.floor(256*Math.random())}if(Fh)for(var Oh=1,Ph=0;Ph<Fh.length;Ph++)Kh[Oh%16]=Kh[Oh%16]^Kh[(Oh-1)%16]/4^Fh.charCodeAt(Ph),Oh++;Gh=Kh}
for(var Qh=Gh,Rh=[],Sh=0;Sh<Qh.length;Sh++)Rh.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(Qh[Sh]&63));function Th(){xg.call(this,"button");this.b=null;this.g=[];this.f={}}
y(Th,xg);oa(Th);k=Th.prototype;k.register=function(){Y(this,"click",this.Ia);Y(this,"keydown",this.ta);Y(this,"keypress",this.ua);yg(this,"page-scroll",this.kb)};
k.unregister=function(){Z(this,"click",this.Ia);Z(this,"keydown",this.ta);Z(this,"keypress",this.ua);Uh(this);this.f={};Th.w.unregister.call(this)};
k.Ia=function(a){a&&!a.disabled&&(this.toggle(a),this.click(a))};
k.ta=function(a,b,c){if(!(c.altKey||c.ctrlKey||c.shiftKey||c.metaKey)&&(b=Vh(this,a))){var d=function(a){var b="";a.tagName&&(b=a.tagName.toLowerCase());return"ul"==b||"table"==b},e;
d(b)?e=b:e=jc(b,d);if(e){e=e.tagName.toLowerCase();if("ul"==e)var f=this.rb;else"table"==e&&(f=this.qb);f&&Wh(this,a,b,c,v(f,this))}}};
k.kb=function(){var a=this.f,b=0;for(d in a)b++;if(0!=b)for(var c in a){b=a[c];var d=G(b.activeButtonNode||b.parentNode,X(this));if(void 0==d||void 0==b)break;Xh(this,d,b,!0)}};
function Wh(a,b,c,d,e){var f=dh(c),g=9==d.keyCode;if(g||32==d.keyCode||13==d.keyCode)if(d=Yh(a,c)){if(p(d.firstElementChild))b=d.firstElementChild;else for(b=d.firstChild;b&&1!=b.nodeType;)b=b.nextSibling;if("a"==b.tagName.toLowerCase()){var h=void 0===h?{}:h;var l=void 0===l?"":l;var n=void 0===n?window:n;n=n.location;h=Af(b.href,h)+l;h instanceof Jb||h instanceof Jb||(h=h.Z?h.Y():String(h),Lb.test(h)||(h="about:invalid#zClosurez"),h=Mb(h));h instanceof Jb&&h.constructor===Jb&&h.f===Kb?h=h.b:(pa(h),
h="type_error:SafeUrl");n.href=h}else sg(b)}else g&&Zh(a,b);else f?27==d.keyCode?(Yh(a,c),Zh(a,b)):e(b,c,d):(h=K(b,X(a,"reverse"))?38:40,d.keyCode==h&&(sg(b),d.preventDefault()))}
k.ua=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||c.metaKey||(a=Vh(this,a),dh(a)&&c.preventDefault())};
function Yh(a,b){var c=X(a,"menu-item-highlight"),d=F(c,b);d&&M(d,c);return d}
function $h(a,b,c){L(c,X(a,"menu-item-highlight"));var d=c.getAttribute("id");d||(d=X(a,"item-id-"+ua(c)),c.setAttribute("id",d));b.setAttribute("aria-activedescendant",d)}
k.qb=function(a,b,c){var d=Yh(this,b);if(d){var e=hg("table",b);b=Xb(document,"td",null,e);d=ai(d,b,Xb(document,"td",null,hg("tr",e)).length,c);-1!=d&&($h(this,a,b[d]),c.preventDefault())}};
k.rb=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=Yh(this,b);d&&(b=Ea(Xb(document,"li",null,b),dh),$h(this,a,b[ai(d,b,1,c)]),c.preventDefault())}};
function ai(a,b,c,d){var e=b.length;a=Da(b,a);if(-1==a)if(38==d.keyCode)a=e-c;else{if(37==d.keyCode||38==d.keyCode||40==d.keyCode)a=0}else 39==d.keyCode?(a%c==c-1&&(a-=c),a+=1):37==d.keyCode?(0==a%c&&(a+=c),--a):38==d.keyCode?(a<c&&(a+=e),a-=c):40==d.keyCode&&(a>=e-c&&(a-=e),a+=c);return a}
function bi(a,b){var c=b.iframeMask;c||(c=document.createElement("IFRAME"),c.src='javascript:""',c.className=X(a,"menu-mask"),fh(c),b.iframeMask=c);return c}
function Xh(a,b,c,d){var e=G(b,X(a,"group")),f=!!a.i(b,"button-menu-ignore-group");e=e&&!f?e:b;f=9;var g=8,h=ye(b);if(K(b,X(a,"reverse"))){f=8;g=9;h=h.top+"px";try{c.style.maxHeight=h}catch(t){}}K(b,"flip")&&(K(b,X(a,"reverse"))?(f=12,g=13):(f=13,g=12));var l;a.i(b,"button-has-sibling-menu")?l=re(e):a.i(b,"button-menu-root-container")&&(l=ci(a,b));C&&!Eb("8")&&(l=null);if(l){var n=ye(l);n=new je(-n.top,n.left,n.top,-n.left)}l=new D(0,1);K(b,X(a,"center-menu"))&&(l.x-=Math.round((we(c).width-we(b).width)/
2));d&&(l.y+=bc(document).y);if(a=bi(a,b))b=we(c),a.style.width=b.width+"px",a.style.height=b.height+"px",He(e,f,a,g,l,n,197),d&&le(a,"position","fixed");He(e,f,c,g,l,n,197)}
function ci(a,b){if(a.i(b,"button-menu-root-container")){var c=a.i(b,"button-menu-root-container");return G(b,c)}return document.body}
k.Ka=function(a){if(a){var b=Vh(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.i(a,"button-has-sibling-menu")?c=a.parentNode:c=ci(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=bi(this,a);d&&c.appendChild(d);(c=!!this.i(a,"button-menu-fixed"))&&(this.f[eg(a).toString()]=b);Xh(this,a,b,c);Mf("yt-uix-button-menu-before-show",a,b);eh(b);d&&eh(d);
this.N(a,"button-menu-action",!0);L(a,X(this,"active"));b=v(this.Ja,this,a,!1);d=v(this.Ja,this,a,!0);c=v(this.Cb,this,a,void 0);this.b&&Vh(this,this.b)==Vh(this,a)||Uh(this);Q("yt-uix-button-menu-show",a);W(this.g);this.g=[V(document,"click",d),V(document,"contextmenu",b),V(window,"resize",c)];this.b=a}}};
function Zh(a,b){if(b){var c=Vh(a,b);if(c){a.b=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");fh(c);a.N(b,"button-menu-action",!1);var d=bi(a,b),e=eg(c).toString();delete a.f[e];P(function(){d&&d.parentNode&&(fh(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}e=G(b,X(a,"group"));
var f=[X(a,"active")];e&&f.push(X(a,"group-active"));Pd(b,f);Q("yt-uix-button-menu-hide",b);W(a.g);a.g.length=0}}
k.Cb=function(a,b){var c=Vh(this,a);if(c){b&&(b instanceof Nb?c.innerHTML=Pb(b):ic(c,b));var d=!!this.i(a,"button-menu-fixed");Xh(this,a,c,d)}};
k.Ja=function(a,b,c){c=qg(c);var d=G(c,X(this));if(d){d=Vh(this,d);var e=Vh(this,a);if(d==e)return}d=G(c,X(this,"menu"));e=d==Vh(this,a);var f=K(c,X(this,"menu-item")),g=K(c,X(this,"menu-close"));if(!d||e&&(f||g))Zh(this,a),d&&b&&this.i(a,"button-menu-indicate-selected")&&((a=F(X(this,"content"),a))&&ic(a,qc(c)),di(this,d,c))};
function di(a,b,c){var d=X(a,"menu-item-selected");A(Wb(d,b),function(a){M(a,d)});
L(c.parentNode,d)}
function Vh(a,b){if(!b.widgetMenu){var c=a.i(b,"button-menu-id");c=c&&E(c);var d=X(a,"menu");c?Od(c,[d,X(a,"menu-external")]):c=F(d,b);b.widgetMenu=c}return b.widgetMenu}
...
k.click=function(a){if(Vh(this,a)){var b=Vh(this,a);if(b){var c=G(b.activeButtonNode||b.parentNode,X(this));c&&c!=a?(Zh(this,c),P(v(this.Ka,this,a),1)):dh(b)?Zh(this,a):this.Ka(a)}a.focus()}this.N(a,"button-action")};
function Uh(a){a.b&&Zh(a,a.b)}
;function ei(a){xg.call(this,a);this.g=null}
y(ei,xg);k=ei.prototype;k.B=function(a){var b=xg.prototype.B.call(this,a);return b?b:a};
k.register=function(){yg(this,"yt-uix-kbd-nav-move-out-done",this.hide)};
k.dispose=function(){fi(this);ei.w.dispose.call(this)};
k.i=function(a,b){var c=ei.w.i.call(this,a,b);return c?c:(c=ei.w.i.call(this,a,"card-config"))&&(c=u(c))&&c[b]?c[b]:null};
k.show=function(a){var b=this.B(a);if(b){L(b,X(this,"active"));var c=gi(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;hi(this,a,c);var d=X(this,"card-visible"),e=this.i(a,"card-delegate-show")&&this.i(b,"card-action");this.N(b,"card-action",a);this.g=a;fh(c);P(v(function(){e||(eh(c),Q("yt-uix-card-show",b,a,c));ii(c);L(c,d);Q("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function gi(a,b,c){var d=c||b,e=X(a,"card");c=ji(a,d);var f=E(X(a,"card")+eg(d));if(f)return a=F(X(a,"card-body"),f),hc(a,c)||(ec(c),a.appendChild(c)),f;f=document.createElement("div");f.id=X(a,"card")+eg(d);f.className=e;(d=a.i(d,"card-class"))&&Od(f,d.split(/\s+/));d=document.createElement("div");d.className=X(a,"card-border");b=a.i(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var g=document.createElement("div");
...
function hi(a,b,c){var d=a.i(b,"orientation")||"horizontal",e=F(X(a,"anchor"),b)||b,f=a.i(b,"position"),g=!!a.i(b,"force-position"),h=a.i(b,"position-fixed");d="horizontal"==d;var l="bottomright"==f||"bottomleft"==f,n="topright"==f||"bottomright"==f;if(n&&l){var t=13;var z=8}else n&&!l?(t=12,z=9):!n&&l?(t=9,z=12):(t=8,z=13);var q=ze(document.body);f=ze(b);q!=f&&(t^=4);if(d){f=b.offsetHeight/2-12;var J=new D(-12,b.offsetHeight+6)}else f=b.offsetWidth/2-6,J=new D(b.offsetWidth+6,-12);var w=we(c);f=
Math.min(f,(d?w.height:w.width)-24-6);6>f&&(f=6,d?J.y+=12-b.offsetHeight/2:J.x+=12-b.offsetWidth/2);w=null;g||(w=10);b=X(a,"card-flip");a=X(a,"card-reverse");Qd(c,b,n);Qd(c,a,l);w=He(e,t,c,z,J,null,w);!g&&w&&(w&48&&(n=!n,t^=4,z^=4),w&192&&(l=!l,t^=1,z^=1),Qd(c,b,n),Qd(c,a,l),He(e,t,c,z,J));h&&(e=parseInt(c.style.top,10),g=bc(document).y,le(c,"position","fixed"),le(c,"top",e-g+"px"));q&&(c.style.right="",e=ye(c),e.left=e.left||parseInt(c.style.left,10),g=$b(window),c.style.left="",c.style.right=g.width-
...
function fi(a){a.g&&a.hide(a.g)}
k.Bb=function(a,b){var c=this.B(a);if(c){if(b){var d=ji(this,c);if(!d)return;b instanceof Nb?d.innerHTML=Pb(b):ic(d,b)}K(c,X(this,"active"))&&(c=gi(this,a,c),hi(this,a,c),eh(c),ii(c))}};
k.isActive=function(a){return(a=this.B(a))?K(a,X(this,"active")):!1};
function ji(a,b){var c=b.cardContentNode;if(!c){var d=X(a,"content"),e=X(a,"card-content");(c=(c=a.i(b,"card-id"))?E(c):F(d,b))||(c=document.createElement("div"));var f=c;M(f,d);L(f,e);b.cardContentNode=c}return c}
function ii(a){var b=a.cardMask;b||(b=document.createElement("IFRAME"),b.src='javascript:""',Od(b,["yt-uix-card-iframe-mask"]),a.cardMask=b);b.style.position=a.style.position;b.style.top=a.style.top;b.style.left=a.offsetLeft+"px";b.style.height=a.clientHeight+"px";b.style.width=a.clientWidth+"px";document.body.appendChild(b)}
;function ki(){xg.call(this,"kbd-nav")}
var li;y(ki,xg);oa(ki);k=ki.prototype;k.register=function(){Y(this,"keydown",this.ra);yg(this,"yt-uix-kbd-nav-move-in",this.za);yg(this,"yt-uix-kbd-nav-move-in-to",this.sb);yg(this,"yt-uix-kbd-move-next",this.Aa);yg(this,"yt-uix-kbd-nav-move-to",this.R)};
k.unregister=function(){Z(this,"keydown",this.ra);W(li)};
k.ra=function(a,b,c){var d=c.keyCode;if(a=G(a,X(this)))switch(d){case 13:case 32:this.za(a);break;case 27:c.preventDefault();c.stopImmediatePropagation();a:{for(c=Ud(a,"kbdNavMoveOut");!c;){c=G(a.parentElement,X(this));if(!c)break a;c=Ud(c,"kbdNavMoveOut")}c=E(c);this.R(c);Q("yt-uix-kbd-nav-move-out-done",c)}break;case 40:case 38:if((b=c.target)&&K(a,X(this,"list")))switch(d){case 40:this.Aa(b,a);break;case 38:d=document.activeElement==a,a=mi(a),b=a.indexOf(b),0>b&&!d||(b=d?a.length-1:(a.length+b-
1)%a.length,a[b].focus(),ni(this,a[b]))}c.preventDefault()}};
k.za=function(a){var b=Ud(a,"kbdNavMoveIn");b=E(b);oi(this,a,b);this.R(b)};
k.sb=function(a){var b=document;try{var c=b&&b.activeElement;var d=c&&c.nodeName?c:null}catch(e){d=null}oi(this,d,a);this.R(a)};
k.R=function(a){if(a)if(nc(a))a.focus();else{var b=jc(a,function(a){return gc(a)?nc(a):!1});
b?b.focus():(a.setAttribute("tabindex","-1"),a.focus())}};
function oi(a,b,c){if(b&&c)if(L(c,X(a)),a=b.id,a||(a="kbd-nav-"+Math.floor(1E6*Math.random()+1),b.id=a),b=a,Td&&c.dataset)c.dataset.kbdNavMoveOut=b;else{if(/-[a-z]/.test("kbdNavMoveOut"))throw Error("");c.setAttribute("data-"+"kbdNavMoveOut".replace(/([A-Z])/g,"-$1").toLowerCase(),b)}}
k.Aa=function(a,b){var c=document.activeElement==b,d=mi(b),e=d.indexOf(a);0>e&&!c||(c=c?0:(e+1)%d.length,d[c].focus(),ni(this,d[c]))};
function ni(a,b){if(b){var c=sc(b,"LI");c&&(L(c,X(a,"highlight")),li=V(b,"blur",v(function(a){M(a,X(this,"highlight"));W(li)},a,c)))}}
function mi(a){if("UL"!=a.tagName.toUpperCase())return[];a=Ea(fc(a),function(a){return"LI"==a.tagName.toUpperCase()});
return Ea(Fa(a,function(a){return dh(a)?jc(a,function(a){return gc(a)?nc(a):!1}):!1}),function(a){return!!a})}
;function pi(){xg.call(this,"menu");this.f=this.b=null;this.g={};this.o={};this.j=null}
y(pi,xg);oa(pi);function qi(a){var b=pi.v();if(K(a,X(b)))return a;var c=b.B(a);return c?c:G(a,X(b,"content"))==b.b?b.f:null}
k=pi.prototype;k.register=function(){Y(this,"click",this.qa);Y(this,"mouseenter",this.ib);yg(this,"page-scroll",this.lb);yg(this,"yt-uix-kbd-nav-move-out-done",function(a){a=this.B(a);ri(this,a)});
this.j=new N};
k.unregister=function(){Z(this,"click",this.qa);this.f=this.b=null;W(Oa($a(this.g)));this.g={};Za(this.o,function(a){ec(a)},this);
this.o={};Md(this.j);this.j=null;pi.w.unregister.call(this)};
k.qa=function(a,b,c){a&&(b=si(this,a),!b.disabled&&gg(c.target,b)&&ti(this,a))};
k.ib=function(a,b,c){a&&K(a,X(this,"hover"))&&gg(c.target,si(this,a))&&ti(this,a,!0)};
k.lb=function(){this.b&&this.f&&ui(this,this.f,this.b)};
function ui(a,b,c){var d=vi(a,b);if(d){var e=we(c);if(e instanceof Sb){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=ve(e,!0);d.style.height=ve(f,!0)}c==a.b&&(e=9,f=8,K(b,X(a,"reversed"))&&(e^=1,f^=1),K(b,X(a,"flipped"))&&(e^=4,f^=4),a=new D(0,1),d&&He(b,e,d,f,a,null,197),He(b,e,c,f,a,null,197))}
function ti(a,b,c){wi(a,b)&&!c?ri(a,b):(xi(a,b),!a.b||gg(b,a.b)?a.La(b):$e(a.j,v(a.La,a,b)))}
k.La=function(a){if(a){var b=yi(this,a);if(b){Mf("yt-uix-menu-before-show",a,b);this.b?gg(a,this.b)||ri(this,this.f):(this.f=a,this.b=b,K(a,X(this,"sibling-content"))||(ec(b),document.body.appendChild(b)),b.style.minWidth=si(this,a).offsetWidth-2+"px");var c=vi(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);M(b,X(this,"content-hidden"));ui(this,a,b);Od(si(this,a),[X(this,"trigger-selected"),"yt-uix-button-toggled"]);Q("yt-uix-menu-show",a);zi(b);Ai(this,a);Q("yt-uix-kbd-nav-move-in-to",
...
k.jb=function(a,b){var c=qg(b);c&&(gg(c,si(this,a))||Bi(this,c)||Ci(this,a))};
k.Db=function(a,b){var c=qg(b);if(c){if(Bi(this,c)){var d=G(c,X(this,"content")),e=sc(c,"LI");e&&d&&hc(d,e)&&Mf("yt-uix-menu-item-clicked",c);c=G(c,X(this,"close-on-select"));if(!c)return;d=qi(c)}ri(this,d||a)}};
function xi(a,b){if(b){var c=G(b,X(a,"content"));c&&A(Wb(X(a),c),function(a){!gg(a,b)&&wi(this,a)&&Ci(this,a)},a)}}
function ri(a,b){if(b){var c=[];c.push(b);var d=yi(a,b);d&&(d=Wb(X(a),d),d=Ka(d),c=c.concat(d),A(c,function(a){wi(this,a)&&Ci(this,a)},a))}}
function Ci(a,b){if(b){var c=yi(a,b);Pd(si(a,b),[X(a,"trigger-selected"),"yt-uix-button-toggled"]);L(c,X(a,"content-hidden"));var d=yi(a,b);d&&Yb(d,{"aria-expanded":"false"});(d=vi(a,b))&&d.parentNode&&ec(d);c&&c==a.b&&(a.f.appendChild(c),a.b=null,a.f=null,a.j&&a.j.F("ROOT_MENU_REMOVED"));Q("yt-uix-menu-hide",b);c=ua(b).toString();W(a.g[c]);delete a.g[c]}}
k.ob=function(a,b){var c=qg(b);c&&Di(this,a,c)};
k.pb=function(a,b){var c=qg(b);if(c){var d=si(this,a);if(d&&(c=sc(c,"LI")))if(c=qc(c).trim(),d.hasChildNodes()){var e=Th.v();(d=F(X(e,"content"),d))&&ic(d,c)}else ic(d,c)}};
function Ai(a,b){var c=yi(a,b);if(c){A(c.children,function(a){"LI"==a.tagName&&Yb(a,{role:"menuitem"})});
Yb(c,{"aria-expanded":"true"});var d=c.id;d||(d="aria-menu-id-"+ua(c),c.id=d);(c=si(a,b))&&Yb(c,{"aria-controls":d})}}
function Di(a,b,c){var d=yi(a,b);d&&K(b,X(a,"checked"))&&(a=sc(c,"LI"))&&(a=F("yt-ui-menu-item-checked-hid",a))&&(A(Wb("yt-ui-menu-item-checked",d),function(a){Rd(a,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),Rd(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function wi(a,b){var c=yi(a,b);return c?!K(c,X(a,"content-hidden")):!1}
function zi(a){A(Xb(document,"UL",null,a),function(a){a.tabIndex=0;var b=ki.v();Od(a,[X(b),X(b,"list")])})}
function yi(a,b){var c=Pf(b,"menu-content-id");return c&&(c=E(c))?(Od(c,[X(a,"content"),X(a,"content-external")]),c):b==a.f?a.b:F(X(a,"content"),b)}
function vi(a,b){var c=ua(b).toString(),d=a.o[c];if(!d){d=document.createElement("IFRAME");d.src='javascript:""';var e=[X(a,"mask")];A(Nd(b),function(a){e.push(a+"-mask")});
Od(d,e);a.o[c]=d}return d||null}
function si(a,b){return F(X(a,"trigger"),b)}
function Bi(a,b){return gg(b,a.b)||gg(b,a.f)}
;function Ei(){ei.call(this,"clickcard");this.b={};this.f={}}
y(Ei,ei);oa(Ei);k=Ei.prototype;k.register=function(){Ei.w.register.call(this);Y(this,"click",this.na,"target");Y(this,"click",this.ma,"close")};
k.unregister=function(){Ei.w.unregister.call(this);Z(this,"click",this.na,"target");Z(this,"click",this.ma,"close");for(var a in this.b)W(this.b[a]);this.b={};for(a in this.f)W(this.f[a]);this.f={}};
...
k.show=function(a){Ei.w.show.call(this,a);var b=this.B(a),c=ua(a).toString();if(!Pf(b,"click-outside-persists")){if(this.b[c])return;b=V(document,"click",v(this.oa,this,a));var d=V(window,"blur",v(this.oa,this,a));this.b[c]=[b,d]}a=V(window,"resize",v(this.Bb,this,a,void 0));this.f[c]=a};
k.hide=function(a){Ei.w.hide.call(this,a);a=ua(a).toString();var b=this.b[a];b&&(W(b),this.b[a]=null);if(b=this.f[a])W(b),delete this.f[a]};
k.oa=function(a,b){var c="yt-uix"+(this.l?"-"+this.l:"")+"-card",d=null;b.target&&(d=G(b.target,c)||G(qi(b.target),c));(d=d||G(document.activeElement,c)||G(qi(document.activeElement),c))||this.hide(a)};
k.ma=function(a){(a=G(a,X(this,"card")))&&(a=a.cardTargetNode)&&this.hide(a)};function Fi(){ei.call(this,"hovercard")}
y(Fi,ei);oa(Fi);k=Fi.prototype;k.register=function(){Y(this,"mouseenter",this.va,"target");Y(this,"mouseleave",this.xa,"target");Y(this,"mouseenter",this.wa,"card");Y(this,"mouseleave",this.ya,"card")};
...
k.va=function(a){if(Gi!=a){Gi&&(this.hide(Gi),Gi=null);var b=v(this.show,this,a),c=parseInt(this.i(a,"delay-show"),10);b=P(b,-1<c?c:200);Nf(a,"card-timer",b.toString());Gi=a;a.alt&&(Nf(a,"card-alt",a.alt),a.alt="");a.title&&(Nf(a,"card-title",a.title),a.title="")}};
...
k.mb=function(a){this.B(a).isCardHidable&&(this.hide(a),Gi=null)};
k.wa=function(a){a&&(a.cardRootNode.isCardHidable=!1)};
k.ya=function(a){a&&this.hide(a.cardTargetNode)};
var Gi=null;function Hi(a,b,c,d,e,f){this.b=a;this.A=null;this.g=F("yt-dialog-fg",this.b)||this.b;if(a=F("yt-dialog-title",this.g)){var g="yt-dialog-title-"+ua(this.g);a.setAttribute("id",g);this.g.setAttribute("aria-labelledby",g)}this.g.setAttribute("tabindex","-1");this.P=F("yt-dialog-focus-trap",this.b);this.ea=!1;this.j=new N;this.C=[];this.C.push(rg(this.b,v(this.tb,this),"yt-dialog-dismiss"));this.C.push(V(this.P,"focus",v(this.hb,this),!0));Ii(this);this.Pa=b;this.Wa=c;this.Va=d;this.J=e;this.Xa=f;this.o=
this.l=null}
var Ji={LOADING:"loading",Gb:"content",Nb:"working"};function Ki(a,b){a.S()||a.j.subscribe("post-all",b)}
function Ii(a){a=F("yt-dialog-fg-content",a.b);var b=[];Za(Ji,function(a){b.push("yt-dialog-show-"+a)});
...
c.offsetHeight);c=b>a?b>e?b:e:b<e?b:e}else c=0}this.f.style.height=c+"px";eh(this.f)}this.sa();c=Li(this);Mi(c);this.l=V(document,"keydown",v(this.nb,this));c=this.b;d=Jf("player-added",this.sa,this);Nf(c,"player-ready-pubsub-key",d);this.Wa&&(this.o=V(document,"click",v(this.zb,this)));eh(this.b);this.g.setAttribute("tabindex","0");Ni(this);this.J||L(document.body,"yt-dialog-active");Uh(Th.v());fi(Ei.v());fi(Fi.v());Q("yt-ui-dialog-show-complete",this)}};
function Oi(){return Ga(Wb("yt-dialog"),function(a){return dh(a)})}
k.sa=function(){if(!this.Xa){var a=this.b;Qd(document.body,"hide-players",!0);a&&Qd(a,"preserve-players",!0)}};
function Li(a){var b=Xb(document,"iframe",null,a.b);A(b,function(a){var b=Pf(a,"onload");b&&(b=u(b))&&V(a,"load",b);if(b=Pf(a,"src"))a.src=b},a);
return Ka(b)}
function Mi(a){A(document.getElementsByTagName("iframe"),function(b){-1==Da(a,b)&&L(b,"iframe-hid")})}
function Pi(){A(Wb("iframe-hid"),function(a){M(a,"iframe-hid")})}
k.tb=function(a){a=a.currentTarget;a.disabled||(a=Pf(a,"action")||"",this.dismiss(a))};
k.dismiss=function(a){if(!this.S()){this.j.F("pre-all");this.j.F("pre-"+a);fh(this.b);fi(Ei.v());fi(Fi.v());this.g.setAttribute("tabindex","-1");Oi()||(fh(this.f),this.J||M(document.body,"yt-dialog-active"),jg(),Pi());this.l&&(W(this.l),this.l=null);this.o&&(W(this.o),this.o=null);var b=this.b;if(b){var c=Pf(b,"player-ready-pubsub-key");c&&(Lf(c),Qf(b,"player-ready-pubsub-key"))}this.j.F("post-all");Q("yt-ui-dialog-hide-complete",this);"cancel"==a&&Q("yt-ui-dialog-cancelled",this);this.j&&this.j.F("post-"+
...
k.hb=function(a){a.stopPropagation();Ni(this)};
function Ni(a){P(v(function(){this.g&&this.g.focus()},a),0)}
x("yt.ui.Dialog",Hi);function Qi(){xg.call(this,"overlay");this.j=this.f=this.g=this.b=null}
y(Qi,xg);oa(Qi);k=Qi.prototype;k.register=function(){Y(this,"click",this.ca,"target");Y(this,"click",this.hide,"close");Ri(this)};
k.unregister=function(){Qi.w.unregister.call(this);Z(this,"click",this.ca,"target");Z(this,"click",this.hide,"close");this.j&&(Lf(this.j),this.j=null);this.f&&(W(this.f),this.f=null)};
k.ca=function(a){if(!this.b||!dh(this.b.b)){var b=this.B(a);a=Si(b,a);b||(b=a?a.overlayParentNode:null);if(b&&a){var c=!!this.i(b,"disable-shortcuts")||!1,d=!!this.i(b,"disable-outside-click-dismiss")||!1;this.b=new Hi(a,c);this.g=b;var e=F("yt-dialog-fg",a);if(e){var f=this.i(b,"overlay-class")||"",g=this.i(b,"overlay-style")||"default",h=this.i(b,"overlay-shape")||"default";f=f?f.split(" "):[];f.push(X(this,g));f.push(X(this,h));Od(e,f)}this.b.show();Q("yt-uix-kbd-nav-move-to",e||a);Ri(this);c||
d||(c=v(function(a){K(a.target,"yt-dialog-base")&&Ti(this)},this),this.f=V(F("yt-dialog-base",a),"click",c));
this.N(b,"overlay-shown");Q("yt-uix-overlay-shown",b)}}};
function Ri(a){a.j||(a.j=Jf("yt-uix-overlay-hide",Ui));a.b&&Ki(a.b,function(){var a=Qi.v();a.g=null;a.b.dispose();a.b=null})}
function Ti(a){if(a.b){var b=a.g;a.b.dismiss("overlayhide");b&&a.N(b,"overlay-hidden");a.g=null;a.f&&(W(a.f),a.f=null);a.b=null}}
function Si(a,b){var c;if(a)if(c=F("yt-dialog",a)){var d=E("body-container");d&&(d.appendChild(c),a.overlayContentNode=c,c.overlayParentNode=a)}else c=a.overlayContentNode;else b&&(c=G(b,"yt-dialog"));return c}
function Vi(){var a=Qi.v();if(a.g)a=F("yt-dialog-fg-content",a.g.overlayContentNode);else a:{if(a=Wb("yt-dialog-fg-content"))for(var b=0;b<a.length;b++){var c=G(a[b],"yt-dialog");if(dh(c)){a=a[b];break a}}a=null}return a}
k.hide=function(a){a&&a.disabled||Q("yt-uix-overlay-hide")};
function Ui(){Ti(Qi.v())}
k.show=function(a){this.ca(a)};var Wi={},Xi=[];function Yi(a){a=G(a,"yt-uix-button-subscription-container");return F("yt-dialog",F("unsubscribe-confirmation-overlay-container",a))}
function Zi(a,b){W(Xi);Xi.length=0;Wi[b]||(Wi[b]=Yi(a));Qi.v().show(Wi[b]);var c=Vi();return new Ke(function(a){Xi.push(rg(c,function(){a()},"overlay-confirmation-unsubscribe-button"))})}
;function $i(){var a=O("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!O("SESSION_INDEX")&&!O("LOGGED_IN"))}
;function aj(){xg.call(this,"subscription-button")}
y(aj,xg);oa(aj);aj.prototype.register=function(){Y(this,"click",this.da);zg(this,Og,this.Ca);zg(this,Pg,this.Ba);zg(this,Qg,this.wb);zg(this,Tg,this.Ca);zg(this,Ug,this.Ba);zg(this,Vg,this.yb);zg(this,Xg,this.vb);zg(this,Yg,this.ub)};
aj.prototype.unregister=function(){Z(this,"click",this.da);aj.w.unregister.call(this)};
aj.prototype.isSubscribed=function(a){return!!this.i(a,"is-subscribed")};
var bj={fa:"hover-enabled",Na:"yt-uix-button-subscribe",Oa:"yt-uix-button-subscribed",Eb:"ypc-enabled",Qa:"yt-uix-button-subscription-container",Ra:"yt-subscription-button-disabled-mask-container"},cj={Fb:"channel-external-id",Sa:"subscriber-count-show-when-subscribed",Ta:"subscriber-count-tooltip",Ua:"subscriber-count-title",Hb:"href",Ib:"insecure",ga:"is-subscribed",Jb:"parent-url",Kb:"clicktracking",Ya:"show-unsub-confirm-dialog",Lb:"show-unsub-confirm-time-frame",Za:"style-type",ha:"subscribed-timestamp",
ia:"subscription-id",Mb:"target",ab:"ypc-enabled"};k=aj.prototype;k.da=function(a){var b=this.i(a,"href"),c=this.i(a,"insecure");if(b)a=this.i(a,"target")||"_self",window.open(b,a);else if(!c)if($i()){b=this.i(a,"channel-external-id");c=this.i(a,"clicktracking");var d=dj(this,a),e=this.i(a,"parent-url");if(this.i(a,"is-subscribed")){var f=this.i(a,"subscription-id"),g=new Kg(b,f,d,a,c,e);ej(this,a)?Zi(a,b).then(function(){U(Sg,g)}):U(Sg,g)}else U(Ng,new Ig(b,d,c,e))}else fj(this,a)};
...
k.Fa=function(a,b,c){b?(Nf(a,cj.ga,"true"),c&&Nf(a,cj.ia,c),this.i(a,cj.Ya)&&(b=new Kd,Nf(a,cj.ha,(b.getTime()/1E3).toString()))):(Qf(a,cj.ga),Qf(a,cj.ha),Qf(a,cj.ia));gj(this,a)};
function dj(a,b){if(!a.i(b,"ypc-enabled"))return null;var c=a.i(b,"ypc-item-type"),d=a.i(b,"ypc-item-id");return{itemType:c,itemId:d,subscriptionElement:b}}
k.Ea=function(a,b){var c=G(a,bj.Qa);Qd(c,bj.Ra,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function gj(a,b){var c=a.i(b,cj.Za),d=!!a.i(b,"is-subscribed");c="-"+c;var e=bj.Oa+c;Qd(b,bj.Na+c,!d);Qd(b,e,d);a.i(b,cj.Ta)&&!a.i(b,cj.Sa)&&(c=X(gh.v()),Qd(b,c,!d),b.title=d?"":a.i(b,cj.Ua));d?P(function(){L(b,bj.fa)},1E3):M(b,bj.fa)}
k.gb=function(a){var b=!!this.i(a,"ypc-item-type"),c=!!this.i(a,"ypc-item-id");!this.i(a,"ypc-enabled")&&b&&c&&(L(a,"ypc-enabled"),Nf(a,cj.ab,"true"))};
k.fb=function(a){this.i(a,"ypc-enabled")&&(M(a,"ypc-enabled"),Qf(a,"ypc-enabled"))};
function hj(a,b){return Ea(Wb(X(a)),function(a){return b==this.i(a,"channel-external-id")},a)}
k.cb=function(a,b,c){var d=Na(arguments,2);A(a,function(a){b.apply(this,Ja(a,d))},this)};
k.M=function(a,b,c){var d=hj(this,a);this.cb.apply(this,Ja([d],Na(arguments,1)))};
function fj(a,b){var c=v(function(a){a.discoverable_subscriptions&&Cf("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.da(b)},a);
oh(c)}
function ej(a,b){if(!a.i(b,"show-unsub-confirm-dialog"))return!1;var c=a.i(b,"show-unsub-confirm-time-frame");return"always"==c||"ten_minutes"==c&&(c=parseInt(a.i(b,"subscribed-timestamp"),10),(new Kd).getTime()<1E3*(c+600))?!0:!1}
;function ij(a){this.b=a;this.D=null;O("SUBSCRIBE_EMBED_HOVERCARD_URL")&&(jj(this),V(this.b,"mouseover",v(this.j,this)),V(this.b,"mouseout",v(this.W,this)),V(this.b,"click",v(this.W,this)),bg(Qg,za(this.f,!0),this),bg(Vg,za(this.f,!1),this),kj(this))}
function jj(a){var b={url:O("SUBSCRIBE_EMBED_HOVERCARD_URL"),style:"bubble",hideClickDetection:!0,show:!1,anchor:a.b,relayOpen:"-1"};a=v(a.g,a);Eg().open(b,a)}
function kj(a){$i()||Jf("LOGGED_IN",function(){this.D&&(this.W(),this.D.close(),this.D=null,jj(this))},a)}
ij.prototype.g=function(a){this.D=a;a=aj.v().isSubscribed(this.b);this.f(a)};
ij.prototype.j=function(){this.D&&this.D.restyle({show:!0})};
ij.prototype.W=function(){this.D&&this.D.restyle({show:!1})};
ij.prototype.f=function(a){if(this.D){a={isSubscribed:a};try{this.D.send("msg-hovercard-subscription",a,void 0,u("gapi.iframes.SAME_ORIGIN_IFRAMES_FILTER"))}catch(b){}}};function lj(){Dg(function(){var a=we(E("yt-subscribe"));a={width:a.width,height:a.height};var b=mj;Eg().ready(a,null,b)})}
function mj(a){if(a.length&&a[a.length-1]){a=a[a.length-1].eurl;var b=E("yt-subscribe"),c=aj.v();if(b=F(X(c),b))a&&(aj.v(),Nf(b,"parent-url",a)),new ij(b)}}
;function nj(a){R.call(this,1,arguments);this.b=a}
y(nj,R);function oj(a,b){R.call(this,2,arguments);this.f=a;this.b=b}
y(oj,R);function pj(a,b,c,d){R.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
y(pj,R);function qj(a,b){R.call(this,1,arguments);this.f=a;this.b=b||null}
y(qj,R);function rj(a){R.call(this,1,arguments)}
y(rj,R);var sj=new S("ypc-core-load",nj),tj=new S("ypc-guide-sync-success",oj),uj=new S("ypc-purchase-success",pj),vj=new S("ypc-subscription-cancel",rj),wj=new S("ypc-subscription-cancel-success",qj),xj=new S("ypc-init-subscription",rj);var yj=!1,zj=[];function Aj(a){a.b?yj?U(Rg,a):U(sj,new nj(function(){U(xj,new rj(a.b))})):Bj(a.f,a.j,a.g,a.source)}
function Cj(a){a.b?yj?U(Wg,a):U(sj,new nj(function(){U(vj,new rj(a.b))})):Dj(a.f,a.l,a.j,a.g,a.source)}
function Ej(a){Fj(Ka(a.b))}
function Gj(a){Hj(Ka(a.b))}
function Ij(a){Jj(a.g,a.f,a.b)}
function Kj(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&U(Qg,new Jg(b,c,a.b.channelInfo))}
function Lj(a){var b=a.b;Za(a.f,function(a,d){U(Qg,new Jg(d,a,b[d]))})}
function Mj(a){U(Vg,new Gg(a.f.itemId));a.b&&a.b.length&&(Nj(a.b,Vg),Nj(a.b,Xg))}
function Bj(a,b,c,d){var e=new Gg(a);U(Og,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=O("PLAYBACK_ID"))&&(c.plid=d);(d=O("EVENT_ID"))&&(c.ei=d);b&&Oj(b,c);wh("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Ha:f,L:c,onSuccess:function(b,c){var d=c.response;U(Qg,new Jg(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&Q("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a)},
ba:function(){U(Pg,e)}})}
function Dj(a,b,c,d,e){var f=new Gg(a);U(Tg,f);var g={};g.c=a;d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=O("PLAYBACK_ID"))&&(d.plid=a);(a=O("EVENT_ID"))&&(d.ei=a);c&&Oj(c,d);wh("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Ha:g,L:d,onSuccess:function(){U(Vg,f)},
ba:function(){U(Ug,f)}})}
function Jj(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new Hg(a,b,c);wh("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",L:d,onError:function(){U(ah,e)},
onSuccess:function(){U($g,e)}})}}
function Fj(a){if(a.length){var b=Ma(a,0,40);U("subscription-batch-subscribe-loading");Nj(b,Og);var c={};c.a=b.join(",");var d=function(){U("subscription-batch-subscribe-loaded");Nj(b,Pg)};
wh("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",L:c,onSuccess:function(c,f){d();var e=f.response,h=e.id;if(qa(h)&&h.length==b.length){var l=e.channel_info_map;A(h,function(a,c){var d=b[c];U(Qg,new Jg(d,a,l[d]))});
a.length?Fj(a):U("subscription-batch-subscribe-finished")}},
onError:function(){d();U("subscription-batch-subscribe-failure")}})}}
function Hj(a){if(a.length){var b=Ma(a,0,40);U("subscription-batch-unsubscribe-loading");Nj(b,Tg);var c={};c.c=b.join(",");var d=function(){U("subscription-batch-unsubscribe-loaded");Nj(b,Ug)};
wh("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",L:c,onSuccess:function(){d();Nj(b,Vg);a.length&&Hj(a)},
onError:function(){d()}})}}
function Nj(a,b){A(a,function(a){U(b,new Gg(a))})}
function Oj(a,b){var c=Cg(a),d;for(d in c)b[d]=c[d]}
;x("yt.setConfig",Cf);x("yt.config.set",Cf);x("ytbin.www.subscribeembed.init",function(){yj=!0;zj.push(bg(Ng,Aj),bg(Sg,Cj));yj||zj.push(bg(Rg,Aj),bg(Wg,Cj),bg(Lg,Ej),bg(Mg,Gj),bg(Zg,Ij),bg(uj,Kj),bg(wj,Mj),bg(tj,Lj));var a=aj.v(),b=X(a);b in Bg||(a.register(),yg(a,"yt-uix-init-"+b,a.init),yg(a,"yt-uix-dispose-"+b,a.dispose),Bg[b]=a);lj()});}).call(this);
